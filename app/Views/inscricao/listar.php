                    ...
                    <tr>
                        ...
                        <td class="text-end" colspan="2">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="<?= base_url("inscricao-cliente/editar/".$inscricao->idInscricao) ?>"> <i class="bi bi-pencil"></i> Editar</a></li>
                                <li>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href="<?= base_url("inscricao-cliente/onDelete/" . $inscricao->idInscricao) ?>" class="btn btn-danger"> <i class="bi bi-trash"></i> Deletar</a>
                </div>
            </div>
        </div>
    </div>
